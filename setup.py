...
requirements = ['beautifulsoup4', 'pycryptodome', 'requests']
...
setup(
    ...
    download_url = 'https://github.com/rafiibrahim8/rsapwn/archive/v{}.tar.gz'.format(__version__),
